...
export const SharedCollection = () => {
  ...
  if (error || !collection) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-destructive mb-4">Collection not found</h1>
      ...
      <div className="container mx-auto p-4">
        <div className="mb-6">
          <p className="text-muted-foreground">
            Shared tile collection • {new Date(collection.created_at).toLocaleDateString()}
          </p>
        </div>
        ...
        {collection.tiles_data.length === 0 && (
          <div className="text-center py-12">
            <p className="text-muted-foreground">No tiles in this collection</p>
          </div>
        )}
      </div>
    </div>
