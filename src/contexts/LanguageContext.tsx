...
const translations = {
  ...
  fr: {
    ...
    dashboard: {
      select: 'Sélectionner le tableau de bord',
      new: 'Nouveau tableau de bord',
      newTitle: 'Créer un nouveau tableau de bord',
      newDesc: 'Donnez un nom à votre nouveau tableau de bord',
      name: 'Nom du tableau de bord',
      namePlaceholder: 'Mon tableau de bord',
      cancel: 'Annuler',
      create: 'Créer',
      creating: 'Création...',
      created: 'Tableau de bord créé',
      createdDesc: 'Votre nouveau tableau de bord est prêt',
      createError: 'Erreur lors de la création du tableau de bord',
      deleted: 'Tableau de bord supprimé',
      deletedDesc: 'Le tableau de bord a été supprimé',
      deleteError: 'Erreur lors de la suppression du tableau de bord',
      cannotDelete: 'Impossible de supprimer',
      cannotDeleteDesc: 'Vous devez avoir au moins un tableau de bord',
      rename: 'Renommer',
      renameTitle: 'Renommer le tableau de bord',
      renameDesc: 'Donnez un nouveau nom à votre tableau de bord',
      renamed: 'Tableau de bord renommé',
      renamedDesc: 'Le nom de votre tableau de bord a été mis à jour',
      renameError: 'Erreur lors du renommage du tableau de bord',
    },
  ...
  es: {
    ...
    dashboard: {
      select: 'Seleccionar panel',
      new: 'Nuevo panel',
      newTitle: 'Crear nuevo panel',
      newDesc: 'Dale un nombre a tu nuevo panel',
      name: 'Nombre del panel',
      namePlaceholder: 'Mi panel',
      cancel: 'Cancelar',
      create: 'Crear',
      creating: 'Creando...',
      created: 'Panel creado',
      createdDesc: 'Tu nuevo panel está listo',
      createError: 'Error al crear panel',
      deleted: 'Panel eliminado',
      deletedDesc: 'El panel ha sido eliminado',
      deleteError: 'Error al eliminar panel',
      cannotDelete: 'No se puede eliminar',
      cannotDeleteDesc: 'Debes tener al menos un panel',
      rename: 'Renombrar',
      renameTitle: 'Renombrar panel',
      renameDesc: 'Dale un nuevo nombre a tu panel',
      renamed: 'Panel renombrado',
      renamedDesc: 'El nombre de tu panel ha sido actualizado',
      renameError: 'Error al renombrar panel',
    },
  ...
  it: {
    ...
    dashboard: {
      select: 'Seleziona dashboard',
      new: 'Nuovo dashboard',
      newTitle: 'Crea nuovo dashboard',
      newDesc: 'Dai un nome al tuo nuovo dashboard',
      name: 'Nome del dashboard',
      namePlaceholder: 'Il mio dashboard',
      cancel: 'Annulla',
      create: 'Crea',
      creating: 'Creazione...',
      created: 'Dashboard creato',
      createdDesc: 'Il tuo nuovo dashboard è pronto',
      createError: 'Errore nella creazione del dashboard',
      deleted: 'Dashboard eliminato',
      deletedDesc: 'Il dashboard è stato eliminato',
      deleteError: 'Errore nell\'eliminazione del dashboard',
      cannotDelete: 'Impossibile eliminare',
      cannotDeleteDesc: 'Devi avere almeno un dashboard',
      rename: 'Rinomina',
      renameTitle: 'Rinomina dashboard',
      renameDesc: 'Dai un nuovo nome al tuo dashboard',
      renamed: 'Dashboard rinominato',
      renamedDesc: 'Il nome del tuo dashboard è stato aggiornato',
      renameError: 'Errore nel rinominare il dashboard',
    },
  ...
  de: {
    ...
    dashboard: {
      select: 'Dashboard auswählen',
      new: 'Neues Dashboard',
      newTitle: 'Neues Dashboard erstellen',
      newDesc: 'Gib deinem neuen Dashboard einen Namen',
      name: 'Dashboard-Name',
      namePlaceholder: 'Mein Dashboard',
      cancel: 'Abbrechen',
      create: 'Erstellen',
      creating: 'Erstellen...',
      created: 'Dashboard erstellt',
      createdDesc: 'Dein neues Dashboard ist bereit',
      createError: 'Fehler beim Erstellen des Dashboards',
      deleted: 'Dashboard gelöscht',
      deletedDesc: 'Das Dashboard wurde gelöscht',
      deleteError: 'Fehler beim Löschen des Dashboards',
      cannotDelete: 'Kann nicht löschen',
      cannotDeleteDesc: 'Du musst mindestens ein Dashboard haben',
      rename: 'Umbenennen',
      renameTitle: 'Dashboard umbenennen',
      renameDesc: 'Gib deinem Dashboard einen neuen Namen',
      renamed: 'Dashboard umbenannt',
      renamedDesc: 'Dein Dashboard-Name wurde aktualisiert',
      renameError: 'Fehler beim Umbenennen des Dashboards',
    },
