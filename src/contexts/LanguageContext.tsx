...
const translations = {
  nl: {
    ...
    dashboard: {
      ...
      name: 'Dashboard naam',
      namePlaceholder: 'Mijn dashboard',
      cancel: 'Annuleren',
      create: 'Maken',
      creating: 'Maken...',
      created: 'Dashboard gemaakt',
      createdDesc: 'Je nieuwe dashboard is klaar',
      createError: 'Fout bij maken dashboard',
      deleted: 'Dashboard verwijderd',
      deletedDesc: 'Het dashboard is verwijderd',
  ...
  en: {
    ...
    dashboard: {
      ...
      createdDesc: 'Your new dashboard is ready',
      createError: 'Error creating dashboard',
      deleted: 'Dashboard deleted',
      deletedDesc: 'The dashboard has been deleted',
